          ...
          >
            <div className="font-Garamond md:mr-[2px] lg:mr-[110px] h-full md:ml-[60px] lg:ml-[10px]">
              ...
              <h1 className="text-2xl md:text-3xl 2xl:text-[32px] leading-[26px] text-lightBlack dark:text-white">
                <Link to="https://unternehmertag.li">
                  {" "}
                  Aktives Sponsoring Unternehmertag{" "}
                </Link>
              </h1>
              <p className="font-Lora relative text-sm sm:text-base text-gray dark:text-lightGray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px]">
                Wir sind stolz darauf, den Unternehmertag in Liechtenstein zu
                unterstützen. Diese bedeutende Veranstaltung bringt kreative
                Köpfe und innovative Unternehmer zusammen. Es ist uns eine
                Freude, Teil dieser inspirierenden Plattform zu sein und den
                Unternehmergeist in unserer Region zu fördern. .{" "}
              </p>
              <Link to="https://unternehmertag.li">
                <HiArrowLongRight
              ...
              <img src="/images/home-1/untern1.jpg" alt="" />
            </div>

            <div className=" md:pl-[30px] relative mt-5 md:mt-0">
              <img src="/images/home-1/untern.jpg" alt="" className="w-full " />
...
export default SponsoringComponent17;
