  ...
  return (
    ...
    >
      ...
      >
        ...
        <SwiperSlide>
          <div
            className="responsive-slide w-full h-[350px] md:h-[550px] xl:h-[750px] bg-[rgba(30,30,30,0.4)] bg-opacity-40 grid items-center justify-center text-white relative pb-[20px] lg:pb-20 xl:pb-0"
            data-aos="fade-down"
          >
            ...
            <div className="w-[221px] h-[50px] border-white border hidden md:flex items-center justify-center absolute left-0 top-1/2 -rotate-90">
              <BiPhoneCall className="w-5 h-5 mr-2 text-khaki" /> +423 222 77 77
            </div>
          </div>

          {/* Add the styles for responsiveness */}
          <style jsx>{`
            .responsive-slide {
        ...
        <SwiperSlide>
          <div
            className="w-full h-[350px] md:h-[550px] xl:h-[750px] bg-[rgba(30,30,30,0.4)] bg-opacity-40 grid items-center justify-center text-white relative pb-[20px] lg:pb-20 xl:pb-0"
            data-aos="fade-down"
          >
            <video
              ref={videoRef}
            ...
            >
              <source
                src="https://babylonbybike.ch/wp-content/uploads/2024/06/vvv.mp4"
                type="video/mp4"
              />
            ...
            <div className="z-10 relative">
              <div className="font-Garamond 2xl:w-[720px] text-center">
                ...
                <h4 className="text-base mb-4"></h4>
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl 3xl:text-6xl font-semibold"></h1>
                {/* Weitere Inhalte */}
              </div>
              <Link to={"/about"}>
        ...
        <SwiperSlide>
          <div
            className="bg-[url('/images/home-1/automat1.jpg')] w-full h-[350px] md:h-[550px] xl:h-[750px] bg-[rgba(30,30,30,0.4)] bg-opacity-40 grid items-center bg-cover justify-center text-white relative pb-[20px] lg:pb-20 xl:pb-0"
            data-aos="fade-down"
          >
            <div className="font-Garamond 2xl:w-[720px] text-center">
              <div className="flex space-x-2 items-center justify-center mb-5 lg:mb-6">
