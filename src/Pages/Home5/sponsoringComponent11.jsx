          ...
          >
            <div className="font-Garamond md:mr-[2px] lg:mr-[110px] h-full md:ml-[60px] lg:ml-[10px]">
              ...
              <h1 className="text-2xl md:text-3xl 2xl:text-[32px] leading-[26px] text-lightBlack dark:text-white">
                <Link to="https://www.unihockey.li/uhcschaan">
                  {" "}
                  TEAMGEIST, FAIRPLAY UND SPORTLICHE HÖCHSTLEITUNGEN{" "}
                </Link>
              </h1>
              <p className="font-Lora relative text-sm sm:text-base text-gray dark:text-lightGray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px]">
                Wir sind stolz darauf, den Unihockeyverein UHC Schaan als
                aktiver Sponsor zu unterstützen. Der UHC Schaan steht für
                Teamgeist, Fairplay und sportliche Höchstleistungen – Werte, die
                auch in unserem Unternehmen fest verankert sind. Durch unser
                Engagement möchten wir dazu beitragen, die großartige Arbeit des
                Vereins zu fördern und die Entwicklung talentierter Spielerinnen
                und Spieler zu unterstützen.{" "}
              </p>
              <Link to="https://www.unihockey.li/uhcschaan">
                <HiArrowLongRight
              ...
              <img src="/images/home-1/uhc1.png" alt="" />
            </div>

            <div className=" md:pl-[30px] relative mt-5 md:mt-0">
              <img
                src="/images/home-1/Teamfotos_Damen_UHC Schaan_Saison 2024-2025_01.jpg.webp"
                alt=""
                className="w-full "
              />
...
export default SponsoringComponent11;
