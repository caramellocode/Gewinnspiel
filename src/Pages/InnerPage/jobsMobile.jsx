import BreadCrumb from "../../BreadCrumb/jobsbreadcrumb";
...
const JobsMobile = () => {
  return (
    <div>
      <BreadCrumb title="Aktuelle Jobs" />
      {/* Pricing  */}
        ...
        <div className="Container">
          ...
          >
            ...
            <p className="font-Lora leading-7 lg:leading-[26px] text-lightGray font-normal text-sm sm:text-base">
             Ist Ihre Wuschstelle nicht vorhanden? Dann senden Sie uns Ihre Initiativbewerbung.<br></br> Wir freuen uns auf Ihre Bewerbung.
            </p>
          </div>
          {/* Pricing Plan */}
              ...
              >
                ...
                <div className="px-5 pb-5 2xl:px-[30px] 2xl:pb-[30px]">
                  ...
                  <div className="flex items-center pb-5 ">
                    ...
                    Fürstentum Liechtenstein, Festanstellung, Per sofort                    </span>
                  </div>
                  ...
                  <div className="py-5 2xl:pb-[30px]">
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        ...
                        Zubereitung von hochwertigen, kreativen Gerichten</p>
                      </li>
                      <li className="flex items-center">
                        <GoDotFill className="w-[9px] h-[9px] text-khaki" />
                        <p className="text-sm sm:text-base lg:text-lg leading-[26px] text-gray dark:text-lightGray font-Lora font-normal ml-2">
                        Gewährleistung der Einhaltung von Qualitätsstandards und Hygienevorschriften
                        </p>
                      </li>
                      <li className="flex items-center">
                        <GoDotFill className="w-[9px] h-[9px] text-khaki" />
                        <p className="text-sm sm:text-base lg:text-lg leading-[26px] text-gray dark:text-lightGray font-Lora font-normal ml-2">
                        Zusammenarbeit mit dem Küchenteam, um einen reibungslosen Ablauf sicherzustellen
                        </p>
                      </li>
                      <li className="flex items-center">
                        <GoDotFill className="w-[9px] h-[9px] text-khaki" />
                  ...
                  <a href="https://cvmanager.ch/applicants/applyforvacancyview/12472" target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="py-5 2xl:pb-[30px]">
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        <GoDotFill className="w-[9px] h-[9px] text-khaki" />
                        <p className="text-sm sm:text-base lg:text-lg leading-[26px] text-gray dark:text-lightGray font-Lora font-normal ml-2">
                        Begrüßung und Unterstützung der Gäste, Beantwortung von Fragen und Bereitstellung exzellenter Serviceleistungen, um eine positive Spielerfahrung zu gewährleisten.                        </p>
                      </li>
                      <li className="flex items-center">
                        <GoDotFill className="w-[9px] h-[9px] text-khaki" />
                        <p className="text-sm sm:text-base lg:text-lg leading-[26px] text-gray dark:text-lightGray font-Lora font-normal ml-2">
              ...
              >
                ...
                <div className="px-5 pb-5 2xl:px-[30px] 2xl:pb-[30px]">
                  ...
                  <div className="flex items-center pb-5 ">
                    ...
                    <span className="text-sm sm:text-base lg:text-lg leading-[26px] text-gray dark:text-lightGray font-Lora font-normal ">
                    Fürstentum Liechtenstein, Festanstellung, Per sofort
                    </span>
                  </div>
                  <hr className="text-lightGray dark:text-gray " />
                  <div className="py-5 2xl:pb-[30px]">
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        <GoDotFill className="w-[9px] h-[9px] text-khaki" />
                        <p className="text-sm sm:text-base lg:text-lg leading-[26px] text-gray dark:text-lightGray font-Lora font-normal ml-2">
                        Herzliche Begrüßung und Betreuung unserer Gäste
                        </p>
                      </li>
                      <li className="flex items-center">
                        <GoDotFill className="w-[9px] h-[9px] text-khaki" />
                        <p className="text-sm sm:text-base lg:text-lg leading-[26px] text-gray dark:text-lightGray font-Lora font-normal ml-2">
                        Empfehlung von Speisen und Getränken aus unserer Speisekarte
                        </p>
                      </li>
                      <li className="flex items-center">
                        <GoDotFill className="w-[9px] h-[9px] text-khaki" />
                        <p className="text-sm sm:text-base lg:text-lg leading-[26px] text-gray dark:text-lightGray font-Lora font-normal ml-2">
                        Aufnahme und präzise Weiterleitung der Bestellungen
                        </p>
                      </li>
                      <li className="flex items-center">
                        <GoDotFill className="w-[9px] h-[9px] text-khaki" />
                        <p className="text-sm sm:text-base lg:text-lg leading-[26px] text-gray dark:text-lightGray font-Lora font-normal ml-2">
                        Fachgerechtes Servieren von Speisen und Getränken                        </p>
                      </li>
                    </ul>
                  </div>
                  <a href="https://cvmanager.ch/applicants/applyforvacancyview/12472" target="_blank" rel="noopener noreferrer">
