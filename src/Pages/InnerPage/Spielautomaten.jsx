...
const Spielautomaten = () => {
  const [routeSelected, setRouteSelected] = useState("");
  const sliderData = [
    {
      id: 1,
      img: "/images/home-1/Spielautomaten_Slider.jpg",
      title: "",
            ...
            <div className="container mx-auto px-5">
              ...
              >
                ...
                <p className="font-Lora leading-[26px] text-lightGray font-normal text-sm sm:text-base">
                  Spass und Unterhaltung garantiert! Im Grand Casino
                  Liechtenstein sorgen 306 Spielautomaten für eine einzigartige
                  Las Vegas Atmosphäre. Das Casino zeichnet sich durch eine
                  Vielfalt an Automaten und spannenden Spielen aus. Es stehen
                  Ihnen traditionelle, wie auch Spielautomaten der neusten
                  Generation zur Verfügung. Sie entscheiden selbst, wie hoch ihr
                  Einsatz ist. Ab 0.20 CHF sind Sie dabei. Ergreifen Sie die
                  Chance auf fantastische Jackpots.
                </p>
                ...
                <div className="flex gap-7 justify-start flex-wrap">
                  {rouletteData.map((roulet, i) => (
                    <button 
                      ...
                      className=" uppercase w-[300px] h-[48px] lg:h-[56px] bg-khaki   before:bg-khaki before:absolute before:left-0 before:top-16 text-base font-Garamond font-medium mt-[-6px] hover-animBg after:bg-normalBlack after:rounded-none hover:before:bg-normalBlack text-white"
                    >
                      {roulet.title}
                    </button>
                  ))}
