          ...
          >
            <div className="font-Garamond md:mr-[2px] lg:mr-[110px] h-full md:ml-[60px] lg:ml-[10px]">
              ...
              <h1 className="text-2xl md:text-3xl 2xl:text-[32px] leading-[26px] text-lightBlack dark:text-white">
                <Link to="https://www.myswitzerland.com/en/experiences/events/3-vaduzer-grand-casino-beatles-party/">
                  {" "}
                  TANZ UND KULTUR{" "}
                </Link>
              </h1>
              <p className="font-Lora relative text-sm sm:text-base text-gray dark:text-lightGray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px]">
                Wir sind stolz darauf, die Beatles Party in Liechtenstein zu
                unterstützen. Dieses Event ist für uns eine besondere
                Gelegenheit, kulturelle Highlights zu fördern und die legendäre
                Musik der Beatles zu feiern. Wir freuen uns darauf, gemeinsam
                mit den Besuchern eine unvergessliche Zeit zu erleben und die
                kulturelle Vielfalt in Liechtenstein zu bereichern.{" "}
              </p>
              <Link to="https://www.myswitzerland.com/en/experiences/events/3-vaduzer-grand-casino-beatles-party/">
                <HiArrowLongRight
              ...
              <img src="/images/home-1/abbey-road-silhouette.png" alt="" />
            </div>

            <div className=" md:pl-[30px] relative mt-5 md:mt-0">
              <img src="/images/home-2/beatle.jpg" alt="" className="w-full " />
...
export default SponsoringComponent15;
