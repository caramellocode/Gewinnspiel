          ...
          >
            <div className="font-Garamond md:mr-[2px] lg:mr-[110px] h-full md:ml-[60px] lg:ml-[10px]">
              ...
              <h1 className="text-2xl md:text-3xl 2xl:text-[32px] leading-[26px] text-lightBlack dark:text-white">
                <Link to="https://varieteambodensee.at">
                  {" "}
                  GRAND MOMENTS{" "}
                </Link>
              </h1>
              <p className="font-Lora relative text-sm sm:text-base text-gray dark:text-lightGray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px]">
                Wir sind stolz darauf,die Variete´ am Bodensee zu unterstützen.
                Die Variete´ am Bodensee ist ein großartiges Event, das jedes
                Jahr stattfindet und viele Menschen begeistert. <br /> Wir
                freuen uns, dieses Event zu unterstützen und dazu beizutragen,
              ...
              <img src="/images/home-1/variete_am_bodensee_2017_011-removebg-preview.png" alt="" />
            </div>

            <div className=" md:pl-[30px] relative mt-5 md:mt-0">
              <img
                src="/images/home-1/Cover-_2024_Rz.png"
                alt=""
                className="w-full "
              />
...
export default SponsoringComponent7;
