...
const Testimonial = () => {
  ...
  return (
    <section
      className="relative overflow-hidden grid items-center justify-center bg-no-repeat bg-cover bg-stone-900"
    ...
    >
      {/* <video
        ...
        playsInline
      >
        <source src="/images/home-1/back.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video> */}
      {/* Weitere Inhalte der Sektion können hier platziert werden */}
      <div style={{ zIndex: 10 }}>
        {/* Inhalte, die über dem Video angezeigt werden */}
        <h1></h1>
        <p></p>
      </div>{" "}
          ...
          <div className="keen-slider__slide number-slide1 hidden sm:block">
            ...
            >
              <div className="bg-white dark:bg-normalBlack p-5 md:p-10 relative before:absolute before:w-[85%]  before:h-[10px] before:bg-khaki before:mx-auto before:-top-[10px] before:left-0 before:right-0 after:absolute after:w-[85%] after:h-[10px] after:bg-khaki after:mx-auto after:-bottom-[10px] after:left-0 after:right-0 hidden sm:block">
                ...
                <img src="/images/home-1/pokerroom.jpg" alt="" />

                <span className="w-[1px] h-[25px] bg-[#ddd]"></span>

                <div className="flex items-center space-x-6 ">
                  <img
                    src="/images/home-1/5525090.png"
                    className="w-[65px] h-[65px]"
                    alt=""
                  />
                  ...
                  <div className="">
                    ...
                    <p className="pt-1 text-sm md:text-base leading-[26px] font-normal text-gray dark:text-lightGray flex items-center">
                      ...
                      <a href="https://gcli.li/events-pokerroom/">Poker Event öffnen</a>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="keen-slider__slide number-slide1 hidden sm:block">
            ...
            >
              <div className="bg-white dark:bg-normalBlack p-5 md:p-10 relative before:absolute before:w-[85%]  before:h-[10px] before:bg-khaki before:mx-auto before:-top-[10px] before:left-0 before:right-0 after:absolute after:w-[85%] after:h-[10px] after:bg-khaki after:mx-auto after:-bottom-[10px] after:left-0 after:right-0 hidden sm:block">
                ...
                <img src="/images/home-1/casino0.jpg" alt="" />
                ...
                <div className="flex items-center space-x-6 ">
                  ...
                  <div className="">
                    ...
                    <p className="pt-1 text-sm md:text-base leading-[26px] font-normal text-gray dark:text-lightGray flex items-center">
                      <span className="w-5 h-[1px] inline-block text-khaki bg-khaki mr-2"></span>
                      <a href="https://gcli.li/events-casino/">Casino Events öffnen</a>
