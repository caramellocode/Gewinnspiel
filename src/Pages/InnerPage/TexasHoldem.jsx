...
const TexasHoldem = () => {
  ...
  const sliderData = [
    {
      id: 1,
      img: "/images/home-1/UTH_Slider.JPG",
      title: "",
      route: "spielautomaten",
      pdfLink:
        "https://gcli.li/Ultimate-Texas-HoldEm.pdf",
    },
  ];
            ...
            <div className="container mx-auto px-5">
              ...
              >
                ...
                <p className="font-Lora leading-[26px] text-lightGray font-normal text-sm sm:text-base">
                  Für all jene, die gerne gegen die Bank Poker spielen wollen
                  ist dieses Spiel genau das Richtige.
                  <br /> Ultimate Texas Hold `em ist ein strategisches
                  Kartenspiel und hat sich in den letzten Jahren zu einem der
                  beliebtesten Spiele im Casino entwickelt. Ziel ist es, ein
                  besseres Blatt als die Bank zu haben. Mit den Zusatzwetten
                  kann man seine Gewinnchancen noch zusätzlich erhöhen. Die
                  Auszahlungsquoten steigern ebenfalls die Attraktivität dieses
                  Spieles. Je früher Sie sich entscheiden Ihre Karten zu spielen,
                  desto mehr können Sie setzen oder Sie warten ab, bis Sie alle
                  Karten gesehen haben und entscheiden sich erst am Schluss.
                  «Auf ein gutes Blatt».
                </p>
