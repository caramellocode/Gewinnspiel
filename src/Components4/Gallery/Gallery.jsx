        ...
        <div className="mt-14">
          <div ref={sliderRef} className="keen-slider">
            <div className="keen-slider__slide number-slide1">
              <div
                className="gallery-effect bg-[url('/images/home-1/SartoPhotography_DSC00465_web-1.jpg')] group"
                data-aos="fade-up"
                data-aos-duration="1000"
              >
                <img
            ...
            <div className="keen-slider__slide number-slide2">
              <div
                className="gallery-effect bg-[url('/images/home-1/cc1.png')] group "
                data-aos="fade-down"
                data-aos-duration="1000"
              >
                <img
                  src="/images/home-1/cc1.png"
                  alt=""
                  className="w-full h-full opacity-0"
                />
                <div className="px-[25px] py-10 absolute bottom-[-300px] lg:bottom-[-330px] 3xl:bottom-[-300px] group-hover:bottom-[25%] sm:group-hover:bottom-[20%]  lg:group-hover:bottom-[20%] left-[18px] right-[18px] my-[18px] transition-all z-20 duration-500 scale-50 group-hover:scale-100 text-center">
            ...
            <div className="keen-slider__slide number-slide3">
              <div
                className="gallery-effect bg-[url('/images/home-1/ccc4.png')] group "
                data-aos="fade-up"
                data-aos-duration="1000"
              >
                <img
            ...
            <div className="keen-slider__slide number-slide4">
              <div
                className="gallery-effect bg-[url('/images/home-1/cc3.png')] group "
                data-aos="fade-down"
                data-aos-duration="1000"
              >
                <img
