      ...
      <section className="container mx-auto overflow-hidden px-5 py-[10px] md:py-0 md:pb-[10px] lg:py-[10px]">
        ...
        <div className="">
          ...
          >
            ...
            <div className="font-Garamond md:ml-[60px] lg:ml-[107px] h-full">
              ...
              <h1 className="text-2xl md:text-3xl 2xl:text-[32px] leading-[26px]  text-lightBlack dark:text-white">
                <Link to=""> BESONDERE ANLÄSSE </Link>
              </h1>
              ...
              Gerne können Sie die Roof Top Bar «Floor Four» auch für Ihre besonderen Anlässe mieten. Unser Team stellt gerne ein passendes Arrangement für Sie zusammen, kontaktieren Sie uns.                <br />
              </p>
