...
const jobsbreadcrumb = ({ title, home }) => {
  const location = useLocation();
  const pathName = location.pathname.split("/")[1];
  return (
    <section className="bg-[url('/images/inner/Jobs_Titelbild.jpg')] bg-no-repeat bg-cover h-[550px] bg-center grid items-center justify-center">
