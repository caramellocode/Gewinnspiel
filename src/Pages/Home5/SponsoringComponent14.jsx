          ...
          >
            <div className="font-Garamond md:mr-[2px] lg:mr-[110px] h-full md:ml-[60px] lg:ml-[10px]">
              ...
              <p className="font-Lora relative text-sm sm:text-base text-gray dark:text-lightGray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px]">
                Die Chaîne des Rôtisseurs Liechtenstein ist stolz auf ihre rund
                110 Mitglieder, darunter 10 professionelle Mitglieder, die sich
                dem kulinarischen Genuss verschrieben haben. Seit 2008 sind auch
                Damen Teil dieser angesehenen Bruderschaft, was die Vielfalt und
                Inklusion innerhalb der Organisation unterstreicht. Ein
                engagierter Vorstand mit sieben Mitgliedern, unter der Leitung
                des Bailli Délégué, lenkt die Geschicke dieser traditionsreichen
                Vereinigung. Weltweit vereint die Chaîne des Rôtisseurs rund
                25.000 Mitglieder in 75 Ländern und ist damit die größte und
                älteste Gourmetorganisation.{" "}
              </p>
              <Link to="https://liechtenstein.chainedesrotisseurs.com/">
                <HiArrowLongRight
              ...
              <img src="/images/home-1/Logo_freigestellt.png" alt="" />
            </div>

            <div className=" md:pl-[30px] relative mt-5 md:mt-0">
              <img src="/images/home-2/PXL_20230908_174137035.jpg" alt="" className="w-full " />
...
export default SponsoringComponent14;
