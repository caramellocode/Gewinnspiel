...
const BookingVideo = () => {
  ...
  return (
    <section className="py-20 xl:py-[120px] bg-[url('/images/home-1/eew.png')] bg-center bg-cover ">
        ...
        >
          ...
          <div className="mt-2 lg:mt-3 mb-2">
           ...
           font-semibold font-Garamond sm:px-[60px] lg:px-[135px] xl:px-[235px] 2xl:px-[335px] 3xl:px-[535px]"
            >
              Einzigartiges Ambiente-Rundumaussicht-Exklussives Sortiment-Besondere Anlässe
            </h1>
          </div>
          <div className="grid items-center justify-center">
            {" "}
