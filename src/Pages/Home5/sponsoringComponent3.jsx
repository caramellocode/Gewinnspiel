          ...
          >
            <div className="font-Garamond md:mr-[2px] lg:mr-[110px] h-full md:ml-[60px] lg:ml-[10px]">
              ...
              <p className="font-Lora relative text-sm sm:text-base text-gray dark:text-lightGray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px]">
                Wir sind stolz darauf, den Golf Club Werdenberg Gams zu unterstützen.
                Der Golf Club Werdenberg Gams ist ein großartiger Verein, der viele
                Menschen begeistert und ihnen die Möglichkeit bietet, Golf zu spielen.
                <br /> Wir freuen uns, den Golf Club Werdenberg Gams zu unterstützen.
                <br />
              </p>
              <Link to="https://golfgams.ch/">
                <HiArrowLongRight
                  className="text-gray hover:text-khaki"
                  size={30}
                />
              </Link>
              <img src="/images/home-1/man3.png"  alt="" />
            </div>

            <div className="w-full md:pl-[30px] relative mt-5 md:mt-0">
              <img
                src="/images/home-1/golfclub-gams-werdenberg_095879_full.jpg"
                alt=""
                className="w-full "
              />
...
export default SponsoringComponent3;